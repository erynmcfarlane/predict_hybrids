...
### I either need to get Josh's help to make these plots a lot prettier, or I need to translate this all to ggplot2
genomic.cline.plot<-function(cline.data){
  plot(0:1, 0:1, type = "n", xlab = "Hybrid index", ylab = 'Probability of Ancestry',cex.lab=2 )
