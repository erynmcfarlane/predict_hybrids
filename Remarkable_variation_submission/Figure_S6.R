...
pdf(height=4, width=16, file="anova_gen100.pdf")
...
for (i in 1:12)
{
  if		(anova_out_gen100[i,2]==0.01 & anova_out_gen100[i,3]==0.2)			{ points(anova_out_gen100[i,5], anova_out_gen100[i,6], pch=21, bg=anova_cols[i], cex=3) }
  else if	(anova_out_gen100[i,2]==0.01 & anova_out_gen100[i,3]==0.9)			{ points(anova_out_gen100[i,5], anova_out_gen100[i,6], pch=22, bg=anova_cols[i], cex=3) }
  else if	(anova_out_gen100[i,2]==0.01 & anova_out_gen10[i,3]==0)				{ hexagon(as.numeric(anova_out_gen100[i,5]), as.numeric(anova_out_gen100[i,6]), scale=0.03, plot_xmin=min(as.numeric(anova_out_gen100[,5:6])), plot_xmax=max(as.numeric(anova_out_gen100[,5:6])), plot_ymin=min(as.numeric(anova_out_gen100[,5:6])), plot_ymax=max(as.numeric(anova_out_gen100[,5:6])), color=anova_cols[i]) }
  else if	(anova_out_gen100[i,2]==0.2 & anova_out_gen100[i,3]==0.2)			{ points(anova_out_gen100[i,5], anova_out_gen100[i,6], pch=24, bg=anova_cols[i], cex=3) }
  else if	(anova_out_gen100[i,2]==0.2 & anova_out_gen100[i,3]==0.9)			{ points(anova_out_gen100[i,5], anova_out_gen100[i,6], pch=25, bg=anova_cols[i], cex=3) }
  else if	(anova_out_gen100[i,2]==0.2 & anova_out_gen100[i,3]==0)				{ points(anova_out_gen100[i,5], anova_out_gen100[i,6], pch=23, bg=anova_cols[i], cex=3) }
}
...
hexagon(0.025, 3.4, scale=0.025, plot_xmin=min(as.numeric(anova_out_gen10[,5:6])), plot_xmax=max(as.numeric(anova_out_gen10[,5:6])), plot_ymin=min(as.numeric(anova_out_gen10[,5:6])), plot_ymax=max(as.numeric(anova_out_gen10[,5:6])), color="black")
dev.off()